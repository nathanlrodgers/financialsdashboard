...
function exportSalesDoc({base,improved,metrics,proj,payback,fee,clientName,activeSc,nrrDelta,selectedInitiatives=[],activeCurve,actuals=[]}){
  const client=clientName.trim()||"Prospect";
...
function SalesDocModal({onClose,onExport,base,improved,metrics,proj,payback,fee,activeClient,activeSc,selectedInitiatives,activeCurve,LOGO_SRC2,INITIATIVES2,CURVES2,INIT_DETAIL2}){
    ...
    <div style={{position:"fixed",inset:0,zIndex:9999,background:"rgba(0,0,0,0.85)",display:"flex",flexDirection:"column"}}>
      <div style={{background:"#0f172a",borderBottom:"1px solid #1e293b",padding:"10px 20px",display:"flex",alignItems:"center",justifyContent:"space-between",flexShrink:0}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:8}}>
          <button onClick={onExport} style={{padding:"5px 12px",borderRadius:6,border:"none",background:B2,color:"#fff",fontSize:10,fontWeight:700,cursor:"pointer"}}>Export PDF</button>
              ...
              {showExportMenu&&(
                <div style={{position:"absolute",top:"calc(100% + 6px)",right:0,background:"#fff",borderRadius:"8px",boxShadow:"0 8px 32px rgba(0,0,0,0.2)",minWidth:"180px",zIndex:200,overflow:"hidden"}}>
                  ...
                  <div onClick={()=>{exportToPDF({base,improved,metrics,proj,payback,fee,clientName:activeClient?.name||"",activeSc,nrrDelta,selectedInitiatives,activeCurve,actuals});setShowExportMenu(false);}} style={{padding:"11px 14px",cursor:"pointer",background:"#fff",borderBottom:"1px solid "+C.silver}} onMouseEnter={e=>e.currentTarget.style.background="#f5f5f5"} onMouseLeave={e=>e.currentTarget.style.background="#fff"}>
                    ...
                    <div style={{fontSize:"9px",color:"#aaa",marginTop:"2px"}}>Data-dense PDF for client review</div>
                  </div>
                  <div onClick={()=>{setShowSalesPreview(true);setShowExportMenu(false);}} style={{padding:"11px 14px",cursor:"pointer",background:"#fff"}} onMouseEnter={e=>e.currentTarget.style.background="#f5f5f5"} onMouseLeave={e=>e.currentTarget.style.background="#fff"}>
                    <div style={{fontSize:"12px",fontWeight:700,color:C.burgundy}}>🎯 Sales Doc</div>
                    <div style={{fontSize:"9px",color:"#aaa",marginTop:"2px"}}>6-page persuasive proposal</div>
                  </div>
                </div>
              )}
            </div>
